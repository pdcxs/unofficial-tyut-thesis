...
#let cover(
  ...
  let info = (
      ...
      major: "XX专业",
      supervisor: ("李四", "讲师"),
      submit-date: datetime.today()) + info
  ...
  text(size:30pt, font: ("Times New Roman", "KaiTi"), weight: "bold")[#underline[#info.session]届本科生毕业设计（论文）]
  ...
  v(40pt)
  text(font:("Times New Roman", "KaiTi"), size: zh(3), "完成日期："+info.submit-date.display("[year]年[month padding:none]月"))
}
